...
def build_data_frame_chronic():
    folders = [
        ...
        ["data/iou_for_eval/MAMMAL_no_sil/", "-sil",750],
    ]
    N = len(folders)
    out_ious = []
    out_method_label = [] 
...
def draw_sil_curve(): 
    ...
    plt.savefig("figs/Fig.2c.png", dpi=1000, pad_inches=0.01, bbox_inches='tight')
    # plt.savefig("figs/Fig.2c.svg", dpi=1000, pad_inches=0.01, bbox_inches='tight')
