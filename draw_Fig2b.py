...
def draw(): 
    ...
    plt.savefig("figs/Fig.2b.png", dpi=1000, bbox_inches='tight', pad_inches=0.01)
    # plt.savefig("figs/Fig.2b.svg", dpi=1000, bbox_inches='tight', pad_inches=0.01) # uncomment this to write vector image.
