...
def eval_compare():
    ...
    # methods = []
    # acc = [] 
    # for index, accs in enumerate(all_data): 
    #     for k in range(17): 
    #         thresh.append(xs[k] * 100)
    #         acc.append(accs[k] * 100) 
    #         methods.append(labels[index]) 
    # data_dict = { 
    #     "method": methods, 
    #     "Error Threshold (cm)": thresh, 
    #     "Accuracy (%)": acc 
    # }
    # data = pd.DataFrame(data = data_dict)
    # data.to_excel("excel/Fig3h.xlsx", sheet_name="data")
    ...
    plt.savefig("figs/Fig.3h.png", dpi=1000, bbox_inches='tight', pad_inches=0.01)
    plt.savefig("figs/Fig.3h.svg", dpi=1000, bbox_inches='tight', pad_inches=0.01)
