...
import os 
from draw_Fig2f import compute_loss 
import pickle 
...
def main_error(): 
    ...
    plt.savefig("figs/Fig.2d.png", dpi=1000, bbox_inches='tight', pad_inches=0.01)
    # plt.savefig("figs/Fig.2d.svg", dpi=1000, bbox_inches='tight', pad_inches=0.01)
