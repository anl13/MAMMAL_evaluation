...
def draw_per_part_error():
    ...
    ### --- redundant code for generating excel. 
    # import pandas as pd 

    # correct_num = [] 
    # methods = []
    # ratio = [] 
    # for index, ratios in enumerate(all_data): 
    #     for k in range(20): 
    #         correct_num.append(k)
    #         ratio.append(ratios[k] * 100) 
    #         methods.append(labels[index]) 
    # data_dict = { 
    #     "method": methods, 
    #     "Number of Correct Keypoints": correct_num, 
    #     "Fraction of Instances(%)": ratio 
    # }
    # data = pd.DataFrame(data = data_dict)
    # data.to_excel("excel/Fig3g.xlsx", sheet_name="data")
