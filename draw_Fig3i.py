...
def draw_xy_shoulder():
    ...
    plt.savefig("figs/Fig.3i.xy.png", dpi=1000, pad_inches=0.01, bbox_inches='tight')
    plt.savefig("figs/Fig.3i.xy.svg", dpi=1000, pad_inches=0.01, bbox_inches='tight')
...
def draw_z_shoulder():
    ...
    ax.xaxis.set_tick_params(width=0.5)
    ax.yaxis.set_tick_params(width=0.5)
    plt.savefig("figs/Fig.3i.z.png", dpi=1000, pad_inches=0.01, bbox_inches='tight')
    plt.savefig("figs/Fig.3i.z.svg", dpi=1000, pad_inches=0.01, bbox_inches='tight')
